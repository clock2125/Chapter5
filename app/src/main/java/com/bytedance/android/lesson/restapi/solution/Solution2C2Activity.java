...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        mRv.setAdapter(new RecyclerView.Adapter() {
            ...
            public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
                ...
                //  Uncomment these 2 lines, assign image url of Feed to this url variable
    ...
    private void postVideo() {
        ...
        if (ContextCompat.checkSelfPermission(this, READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    ...
                    .build();
            Call<PostVideoResponse> call = retrofit.create(IMiniDouyinService.class).postvideo("16061050", "he", file1, file2);
    ...
    public void fetchFeed(View view) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        Call<FeedResponse> call = retrofit.create(IMiniDouyinService.class).feedreponse();
        call.enqueue(new Callback<FeedResponse>() {
            ...
            public void onResponse(Call<FeedResponse> call, Response<FeedResponse> response) {
                ...
                if(response.body().getSuccess()){
                    Toast toast = Toast.makeText(getApplicationContext(), "拉取成功！", Toast.LENGTH_SHORT);
                    toast.show();
                    mFeeds = response.body().getFeeds();
                    mRv.getAdapter().notifyDataSetChanged();
                }
                else{
                    Toast toast = Toast.makeText(getApplicationContext(), "拉取失败！", Toast.LENGTH_SHORT);
                    toast.show();
                }
                resetRefreshBtn();
            }
